...
public class CategoryActivity extends AppCompatActivity {
    ...
    private List<String> recycle = Arrays.asList("사료나 퇴비로 만들 수 없으므로 일반 종량제 봉투로 배출해주세요.",
            ...
            "깨지지 않도록 주의하여 형광등 판매처, 동사무소, 아파트 관리사무소 형광등 수집함에 배출해주세요. 단, 깨진 형광등은 종량제봉투에 담아서 배출해주세요.",
            "플라스틱이나 알루미늄 뚜껑 제거 후 내용물을 깨끗이 비운 후 배출해주세요. 깨진 유리는 신문지에 싸서 종량제 봉투에 버리고, 양이 많을 경우 특수구격마대(불연물질)를 구매하여 배출해주세요.",
            "내용물을 비우고 물로 헹구는 등 이물질을 제거하여 배출해주세요. 음식물 등의 이물질이 묻은 경우 일반 종량제 봉투로 배출해주세요.",
            "음식물 등의 이물질을 제거하고, 흩날리지 않도록 봉투에 담아 배출해주세요. 이물질제거가 어려운 경우 일반 종량제 봉투에 배출해주세요.",
            ...
            "물기가 닿지 않도록 투명비닐봉지에 담아서 배출하거나 의류수거함에 넣어주세요. (걸레, 수건 등은 재활용이 불가능하므로, 일반종량제 봉투에 버려야합니다.)",
            "도기류는 불에 타지 않은 폐기물이므로, 불연재 봉투로 배출해주세요.",
            "이물질이 섞이지 않도록 한 후 봉투에 넣거나 끈으로 묶어서 배출해주세요. 단, 재질 혼합 제품은 재활용이 불가합니다.",
            "동사무소에 반드시 신고 후 신고필증을 부착하여 배출해야합니다. (단, 원형이 훼손되지 않은 대형 폐가전의 경우 무상 방문수거 예약 배출이 가능합니다.)",
