...
public class MywritingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_first.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MywritingActivity.this, CategoryActivity.class);
        ...
        btn_second.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MywritingActivity.this, ListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_third.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MywritingActivity.this, MyActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MywritingActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
...
//        });
        ...
        postView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Intent intent = new Intent(MywritingActivity.this, DetailActivity.class);
                startActivity(intent);
            }
        });
